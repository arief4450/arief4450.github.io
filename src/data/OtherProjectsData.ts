...
export default [
    new ProjectData("project-6", "Mencari Bee-bee", "img/projects/project-6-icon.png", `
    <div class="paragraph">
    ...
    `, "#c10606", false, true),
    new ProjectData("project-7", "IRAMA", "img/projects/project-7-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-8", "Mencari BeeBee", "img/projects/project-8-icon.png", `
    <div class="paragraph">
